  ...
  return (
    <html lang={htmlLang(locale)}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Figtree:wght@400;500;600;700&family=Fredoka:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&family=Inter:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body className="shell-app" data-style="travor" suppressHydrationWarning>
