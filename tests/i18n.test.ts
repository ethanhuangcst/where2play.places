...
describe("i18n catalogs", () => {
  ...
  it("should_define_plan_progressive_preview_keys_in_all_locales", () => {
    const keys = [
      ...
      "play.plan.travel_tips_visa",
      "play.plan.travel_tips_visa_link",
      "play.plan.travel_tips_visa_link_with_requirement",
      "play.plan.travel_tips_visa_source",
      "play.plan.travel_tips_visa_requirement.visa_free",
      "play.plan.travel_tips_visa_requirement.visa_free_days",
      "play.plan.travel_tips_visa_requirement.visa_required",
      "play.plan.travel_tips_visa_requirement.special",
      "play.plan.travel_tips_visa_requirement.e_visa",
      "play.plan.travel_tips_visa_requirement.visa_on_arrival",
      "play.plan.travel_tips_visa_requirement.eta",
      "play.plan.travel_tips_visa_requirement.unknown",
      "play.plan.travel_tips_visa_section.documents",
      "play.plan.travel_tips_visa_section.process",
      "play.plan.travel_tips_visa_section.processing_time",
      "play.plan.travel_tips_visa_section.cost",
      "play.plan.travel_tips_visa_section.validity",
      "play.plan.travel_tips_visa_section.max_stay",
      "play.plan.travel_tips_visa_section.extension",
      "play.plan.travel_tips_visa_section.embassy",
      "play.plan.travel_tips_visa_section.transit_visa",
      "play.plan.travel_tips_visa_extension.possible",
      "play.plan.travel_tips_visa_extension.not_possible",
      "play.plan.travel_tips_visa_verified",
      "play.plan.travel_tips_visa_need_nationality",
      "play.plan.travel_tips_visa_need_nationality_cta",
      "play.plan.travel_tips_visa_unavailable",
    ] as const;
    for (const locale of ["EN", "CN", "HK", "TW"] as const) {
